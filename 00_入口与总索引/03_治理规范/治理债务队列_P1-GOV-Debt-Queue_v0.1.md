...
| 5c | 生鲜剔除(内购无成本) | ✅**已落地** | —— | 按生鲜档案剔808行;数据异常35%→11% | 完成 |
| 5d | 非生鲜成本缺失(联营等) | **评审完·荐方案A** | 推荐:成本缺失→进cost_missing_review_pool不进金矿(不按品类整剔) | 六哥签字→代码同步 | P1 |
| 5e | 死货二级闸(近90天动销) | **评审完·荐新增** | 剔后死货34%最大污染;荐销量≥4且库龄≤90,死货进dead_stock_pool | 六哥签字→代码同步 | P1 |
| 5f | P85 是否上 | **评审:暂不上** | 防误杀小众好货+守最简;留v0.3备选 | 两闸后若仍泛化再议 | P2 |
