...
| 5g | 数据质量范围筛选机制 | ✅**§3.1.3已立** | 防过度泛化:生鲜=client_specific_excluded非品类永久排除 | 下一轮代码用客户级开关,不硬编码fresh_excluded永久 | P1 |
| 5d | 成本可信闸(成本缺失) | ✅**§3.1.2签字** | 成本缺失→cost_missing_review_pool不进金矿(联营暂统一入此池) | CODEX-Goldmine-Rule-Tighten-Fix-001代码同步 | P1 |
| 5e | 近90天动销闸(死货) | ✅**§3.1.2签字** | 销量≥4且库龄≤90;死货进dead_stock_pool | 同上(代码同步) | P1 |
