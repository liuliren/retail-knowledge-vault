...
- **角色闸防误杀**:低销 ≠ 该砍,先过引流/利润/形象/补充/季节五角色豁免(见 [[SKU角色层与目的品保护机制_v0.1.6]])。
...
- **角色闸(已自动跑)**:enrich.py 已按五角色(引流/利润/形象/补充/季节)+ GBA锁定(A级×top品牌族)标记**受保护**,产出**净可汰清单**。Agent 复核角色判得对否,**净可汰款逐一列进诊断卡**(可签)。见 [[SKU角色层与目的品保护机制_v0.1.6]]。
