...
open_loops:
  - KB-P0遗留裁决①: 99_归档120个删除无台账记录→A补登台账commit / B恢复 [执行报告§9]
  - KB-P0遗留裁决②: C组206件入git候选(含27个KB页+3张DEC裁决+签字门台账从未入git)→清单在输出区 [建议全收]
  - KB-P1四轮待排期: 链接债/副本收敛/治理draft31件/gitignore修正 [审计报告§5]
...
completed_2026-07-02_晚:
  ...
  - ✅ P0-3 git部分封板(92a429f S4清仓+65bdca6 会话编辑·中途一次误commit已回滚留痕)
